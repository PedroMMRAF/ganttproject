...
public class TaskImpl implements Task {
    ...
    private void setTaskInfos() {
        if (myTaskInfo == null) return;
        myTaskInfo.setName(myName);
        myTaskInfo.setPriority(myPriority);
        myTaskInfo.setStartDate(myStart);
        myTaskInfo.setEndDate(myEnd);
        myTaskInfo.setDuration(myLength);
        myTaskInfo.setNotes(myNotes);
    }
    ...
    public void setName(String name) {
        ...
        this.myTaskInfo.setName(myName);
    }
    ...
    public void setPriority(Priority priority) {
        myPriority = priority;
        this.myTaskInfo.setPriority(priority);
    }
    ...
    public void setStart(GanttCalendar start) {
        ...
        recalculateActivities();
        adjustNestedTasks();
        this.myTaskInfo.setStartDate(start);
    }
    ...
    public void setEnd(GanttCalendar end) {
        myEnd = end;
        recalculateActivities();
        this.myTaskInfo.setEndDate(end);
    }
    ...
    public void setCompletionPercentage(int percentage) {
        if (percentage != myCompletionPercentage) {
            ...
            this.myTaskInfo.setCompletionPercentage(percentage);
        }
    }
    ...
    public void setNotes(String notes) {
        myNotes = notes;
        this.myTaskInfo.setNotes(notes);
    }
    ...
    public void addNotes(String notes) {
        myNotes += notes;
        this.myTaskInfo.addNotes(notes);
    }
...
//      }
    ...
    public String getTaskMainInfo() {
        return this.myTaskInfo.getTaskMainInfoHTML();
    }
